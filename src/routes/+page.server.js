...
export async function load() {
  try {
    console.log('🔌 Server: Fetching CaterSync-AI data from database...');
    ...
    console.log('✅ Server: Successfully fetched data from PostgreSQL.');
    ...
    console.warn('⚠️ Server: PostgreSQL database connection failed or table not seeded. Falling back to Mock Data.');
